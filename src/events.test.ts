...
describe('buildAiGeneration', () => {
    ...
    test('maps all fields correctly with privacy off', () => {
        ...
        expect(result.properties.$ai_output_choices).toEqual([{ role: 'assistant', content: 'Hello! How can I help?' }])
    ...
    test('toolResult with toolUseId maps to tool_call_id', () => {
        const rawInput: unknown[] = [{ role: 'toolResult', toolUseId: 'call_abc123', content: 'result data' }]
